...
function StaticText01(){
    return (
        <div className="StaticText01">
            ...
            <h3>CEAB Graduate Attributes:			</h3>
            <ul>
...
function StaticText02(){
    return (
        <div className="StaticText02">
            <h2>Course Content Categories	</h2>
            ...
            <Form03/>
            <h2>Laboratory Experience</h2>
            <p>Ignore this table if the course does not have a laboratory section</p>
            <Form04/>
